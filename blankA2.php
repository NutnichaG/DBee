...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="">A2 STANDING Ticket</h1>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="row">
                <div class="mx-auto col-lg-6 col-10">
                  ...
                  <form class="text-left">
                    ...
                    </div><a class="btn btn-primary" href="user-my_ticket.php">Payment</a>
                  </form>
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="tabtwo" role="tabpanel">
              <p class="lead text-center">Please bring this QR-code to counter service within 30 minuits.</p><img class="img-fluid d-block mx-auto" src="../../../../../xampp/htdocs/DBee/DBee_QRcode.png">
            </div>
